create table Users (user_id serial  not null primary key unique  , username varchar unique not null, password varchar not null , name varchar not null, photo varchar, email varchar );
